...
namespace Blue.Airport.Win.Lib
{
    ...
    public abstract class SqlHelper
    {
        ...
        public static DataTable GetDataTable(SqlConnection conn, CommandType cmdType, string cmdText, params SqlParameter[] cmdParms)
        {
            DataSet ds = GetDataSet(conn, cmdType, cmdText, cmdParms);
